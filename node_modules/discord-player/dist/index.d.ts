...
declare class ExtractorExecutionContext extends PlayerEventsEmitter<ExtractorExecutionEvents> {
     ...
     */
    requestBridgeFrom(track: Track, sourceExtractor: BaseExtractor | null, targetExtractor: ExtractorResolvable): Promise<ExtractorStreamable | null>;
    /**
...
type TrackLike = string | Track | SearchResult | Track[] | Playlist | AudioResource;
...
declare class Player extends PlayerEventsEmitter<PlayerEvents> {
     ...
     * ```
     */
    search(searchQuery: TrackLike, options?: SearchOptions): Promise<SearchResult>;
    /**
...
declare const ErrorCodes: {
    readonly ERR_OUT_OF_SPACE: "ERR_OUT_OF_SPACE";
    readonly ERR_INVALID_ARG_TYPE: "ERR_INVALID_ARG_TYPE";
    readonly ERR_NO_RESULT: "ERR_NO_RESULT";
    readonly ERR_NOT_IMPLEMENTED: "ERR_NOT_IMPLEMENTED";
    readonly ERR_NOT_EXISTING: "ERR_NOT_EXISTING";
    readonly ERR_OUT_OF_RANGE: "ERR_OUT_OF_RANGE";
    readonly ERR_NO_VOICE_CONNECTION: "ERR_NO_VOICE_CONNECTION";
    readonly ERR_VOICE_CONNECTION_DESTROYED: "ERR_VOICE_CONNECTION_DESTROYED";
    readonly ERR_NO_VOICE_CHANNEL: "ERR_NO_VOICE_CHANNEL";
    readonly ERR_INVALID_VOICE_CHANNEL: "ERR_INVALID_VOICE_CHANNEL";
    readonly ERR_NO_RECEIVER: "ERR_NO_RECEIVER";
    readonly ERR_FFMPEG_LOCATOR: "ERR_FFMPEG_LOCATOR";
    readonly ERR_NO_AUDIO_RESOURCE: "ERR_NO_AUDIO_RESOURCE";
    readonly ERR_NO_GUILD_QUEUE: "ERR_NO_GUILD_QUEUE";
    readonly ERR_NO_GUILD: "ERR_NO_GUILD";
    readonly ERR_INFO_REQUIRED: "ERR_INFO_REQUIRED";
    readonly ERR_SERIALIZATION_FAILED: "ERR_SERIALIZATION_FAILED";
    readonly ERR_DESERIALIZATION_FAILED: "ERR_DESERIALIZATION_FAILED";
    readonly ERR_ILLEGAL_HOOK_INVOCATION: "ERR_ILLEGAL_HOOK_INVOCATION";
    readonly ERR_NOT_EXISTING_MODULE: "ERR_NOT_EXISTING_MODULE";
    readonly ERR_BRIDGE_FAILED: "ERR_BRIDGE_FAILED";
};
...
declare class TypeUtil {
    ...
    static isDiscordPlayerError(t: unknown): t is DiscordPlayerError;
}
