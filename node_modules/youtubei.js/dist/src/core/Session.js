...
class Session extends EventEmitter {
    ...
    static create() {
        return __awaiter(this, arguments, void 0, function* (options = {}) {
            ...
            return new _a(context, api_key, api_version, account_index, options.retrieve_player === false ? undefined : yield Player.create(options.cache, options.fetch, options.po_token), options.cookie, options.fetch, options.cache, options.po_token);
        });
    }
    /**
