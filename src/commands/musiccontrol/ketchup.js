...
module.exports = {
    ...
    callback: async (client, interaction) => {
        ...
        const result = await client.player.search('https://www.youtube.com/watch?v=hLeUL4i9PNw', {
        ...
        await interaction.editReply('Aserejé, ja de je de jebe tu de jebere sebiunouva\n' +
